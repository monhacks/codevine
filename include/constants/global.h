...
#define BAG_ITEMS_COUNT 30 //decide this
#define BAG_KEYITEMS_COUNT 30
#define BAG_POKEBALLS_COUNT 26
#define BAG_TMHM_COUNT 64 //decide this
#define BAG_BERRIES_COUNT 67
#define OBJECT_EVENT_TEMPLATES_COUNT 64
#define DECOR_MAX_SECRET_BASE 1
#define DECOR_MAX_PLAYERS_HOUSE 3
#define APPRENTICE_COUNT 4
#define APPRENTICE_MAX_QUESTIONS 9
#define MAX_REMATCH_ENTRIES 78 // only REMATCH_TABLE_ENTRIES (78) are used - decide this
