...
const u8 gText_DexHoennTitle[] = _("Hoenn Dex"); //mod this with new region name
...
const u8 gText_Events[] = _("EVENT"); // Unused
...
const u8 gText_DepositItem[] = _("Deposit");
const u8 gText_WithdrawItem[] = _("Withdraw");
const u8 gText_TossItem[] = _("Toss");
...
const u8 gText_LanettesPC[] = _("Lanette's PC"); // mod with new region
...
const u8 gText_ClawFossil[] = _("Claw Fossil"); // mod with new region
...
const u8 gText_DexHoenn[] = _("Hoenn"); //mod later for new region name
...
const u8 gText_Hoenn[] = _("Hoenn"); //mod later for new region name
...
const u8 gEasyChatGroupName_Adjectives[] = _("Adjective");
...
const u8 gText_Rechoose[] = _("Reselect");
